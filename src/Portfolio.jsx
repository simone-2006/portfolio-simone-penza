...
const SKILL_CATEGORIES = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "REST API", icon: <Globe size={15} />, color: "green" },
    ],
  },
  {
...
export default function Portfolio() {
  ...
  return (
    ...
    >
      {/* ── HEADER ── */}
      <motion.header
        className="fixed top-0 left-0 right-0 z-50 border-b border-slate-800/60 backdrop-blur-md bg-slate-950/80"
      ...
      >
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-slate-800 bg-slate-950/95 px-6 py-4 flex flex-col gap-4">
            {NAV_ITEMS.map(({ id, label }) => (
              <button
                key={id}
                onClick={() => scrollTo(id)}
        ...
        <motion.div className="max-w-6xl mx-auto w-full grid md:grid-cols-[3fr_2fr] gap-12 items-center relative">
          <motion.div>
            ...
            <motion.h1
              ...
              transition={{ duration: 0.7, delay: 0.2 }}
            >
              <span className="text-slate-50">Simone</span>
              <br />
              <span className="text-slate-500">Penza</span>
            </motion.h1>
          ...
          >
            <motion.div className="relative w-64 h-64 flex items-center justify-center">
              ...
              <div className="absolute inset-16 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center z-10">
          ...
          <div className="grid md:grid-cols-[auto_1fr] gap-16 items-start">
            <div className="flex justify-center md:justify-start">
              <div className="relative shrink-0">
                <div className="w-40 h-40 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center overflow-hidden">
            ...
            <div>
              <h2 className="text-4xl font-bold text-slate-50 mb-6 leading-tight">
                Chi sono
              </h2>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-4xl font-bold text-slate-50 mb-16 leading-tight">
            Competenze
          </h2>
              ...
              <div key={cat.label}>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                  {cat.skills.map((skill) => (
                    <motion.div
                      key={skill.name}
                      className="group border border-slate-800 hover:border-cyan-400/40 rounded-lg px-4 py-3 flex items-center gap-2.5 bg-slate-900/30 hover:bg-slate-900/70 transition-all duration-200 cursor-default"
                      whileHover={{
                        scale: 1.07,
      ...
      <motion.section
        id="cv"
        className="py-32 px-6 bg-slate-900/30"
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 0.7 }}
          ...
          <div className="grid md:grid-cols-[2fr_1fr] gap-16 items-start">
            <div className="space-y-10">
              {EXPERIENCES.map((exp, i) => (
                <div
                  key={i}
                  className="relative pl-7 border-l border-slate-800"
                >
                  ...
                  <h3 className="text-slate-100 font-semibold text-base mb-0.5">
                    {exp.role}
                  </h3>
            ...
            <div className="sticky top-24">
              <div className="border border-slate-800 rounded-xl p-6 bg-slate-900/50">
                ...
                <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                  Scarica il CV completo per un quadro dettagliato di
                  esperienze, formazione e progetti.
                </p>
                <a
                  href="#"
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-slate-400 text-base leading-relaxed mb-10 max-w-sm">
              Hai un progetto in mente, una collaborazione da proporre, o vuoi
              semplicemente fare due chiacchiere? Scrivimi.
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {["name", "email"].map((field) => (
              <div key={field}>
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-lg px-4 py-3 text-slate-100 text-sm placeholder-slate-700 focus:outline-none focus:border-cyan-400/50 focus:ring-1 focus:ring-cyan-400/10 transition-colors duration-200"
                  placeholder={
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-900 border border-slate-800 rounded-lg px-4 py-3 text-slate-100 text-sm placeholder-slate-700 focus:outline-none focus:border-cyan-400/50 focus:ring-1 focus:ring-cyan-400/10 transition-colors duration-200 resize-none"
      ...
      {/* ── FOOTER ── */}
      <motion.footer
        className="border-t border-slate-800/60 py-8 px-6"
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
